...
style="wigth: 100px;
			 ...
			 <div id="main">
			   <div id="news">
				 ...
				 <!--Статья-->
				 <div class="article">
				    <img src="img/3.jpg" alt="test" title="Test">
					<span> Домашнее мыловарение: преимущества </span>
					</div>
					
					<div class="article">
					<img src="img/4.jpg" alt="test" title="Test">
					<span> Из чего изготавливают натуральное мыло </span>
					</div>
					
					<div class="article">
					<img src="img/2.jpg" alt="test" title="Test">
					<span> Способы приготовления мыла </span>
					</div>
					
					<div class="article">
					<img src="img/1.jpg" alt="test" title="Test">
					<span> Польза и вред мыла, добавки в мыле </span>
					</div>
